...
/**
 * This class is used to store all important values of a while loop. This class contains the condition, the condition
 * result, a boolean representing if the loop is currently repeating and an array list containing the instructions of
 * the while body.
 */
