...
public class AggregateValue extends Value {
    ...
    public AggregateValue(
            IType datatype, int symbolIdx, IMemorySpace parentSpace, Object internalValue) {
    ...
    public AggregateValue(
            IType datatype, int symbolIdx, Object internalValue, IMemorySpace ownMemorySpace) {
        super(datatype, internalValue, symbolIdx);
