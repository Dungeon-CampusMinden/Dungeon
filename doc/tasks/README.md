...
|                                      | **GUI Button drücken** | **GUI Checkboxen anhaken** | **GUI Text eingeben** | **Item an NPC abgeben** | **Item(s) in Container ablegen** | **Item(s) aus Container nehmen** | **Blöcke schieben** | **Schalter betätigen** | **Kämpfen** |
|--------------------------------------|------------------------|----------------------------|-----------------------|-------------------------|----------------------------------|----------------------------------|---------------------|------------------------|-------------|
| **Single Choice**                    |                        |                            |                       |                         |                                  |                                  |                     |                        |             |
| **Multiple Choice**                  |                        |                            |                       |                         |                                  |                                  |                     |                        |             |
| **Lückentext**                       |                        |                            |                       |                         |                                  |                                  |                     |                        |             |
...
| **Ersetzen**                         |                        |                            |                       |                         |                                  |                                  |                     |                        |             |
| **Kombinieren**                      |                        |                            |                       |                         |                                  |                                  |                     |                        |             |
| **Objekte in Reihenfolge auswählen** |                        |                            |                       |                         |                                  |                                  |                     |                        |             |
| **Matrix füllen**                    |                        |                            |                       |                         |                                  |                                  |                     |                        |             |
