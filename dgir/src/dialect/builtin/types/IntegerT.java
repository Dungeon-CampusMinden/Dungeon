...
public class IntegerT extends Type {
  ...
  /**
   * Take a number of any integer type and convert it to the correct type for this IntegerT. For
   * example, if this is an INT16 and the input is a Byte, convert it to a Short.
   *
