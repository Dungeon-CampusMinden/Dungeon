...
$cards.concat([
	*part([
	...
	], caption: "Das E-Assessment"),
	*part([\
		c[:i2_found_correct] = "*Das richtige Ergebis wurde gefunden.*<br>**Behaltet diese Karte bis zur Meldung beim Dozenten.**",
		c[:i2_start] = 'Die Tür von Dr. K. Igel steht offen: **"Mir ist vorhin eingefallen, dass die Frist zur Einreichung meines Forschungsantrags heute um Mitternacht abläuft, also habe ich nicht viel Zeit. Lasst mich nur schnell euer Ergebnis angucken.."**<br>*Legt alle Karten für "Das E-Assessment" beiseite.*',
