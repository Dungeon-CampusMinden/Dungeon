...
public class C2SConverterTest {
  ...
  public void testInputMessageCastSkillRoundTrip() {
    InputMessage message =
        new InputMessage(
            ...
            new InputMessage.CastSkill(new Point(3.0f, 4.0f)));
  ...
  public void testInputMessageNextSkillRoundTrip() {
    InputMessage message =
        new InputMessage(
            1, 1, (short) 1, InputMessage.Action.NEXT_SKILL, new InputMessage.SkillChange(true));
  ...
  public void testInputMessagePrevSkillRoundTrip() {
    InputMessage message =
        new InputMessage(
            2, 3, (short) 4, InputMessage.Action.PREV_SKILL, new InputMessage.SkillChange(false));
