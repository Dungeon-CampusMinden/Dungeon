...
public class TestDslFileLoader {
    ...
    private static final String PATH_TO_DNGFILE_AS_STRING =
            PATH_TO_ASSETS_AS_STRING + "/simple.dng";
    ...
    public void processArguments_oneJar() throws IOException {
        ...
        assertTrue(
                paths.stream()
                        .anyMatch(p -> p.endsWith(PATH_OF_SECOND_DNGFILE_IN_JAR.normalize())));
                ...
                new File(
                        Objects.requireNonNull(
                                        classLoader.getResource(
                                                PATH_TO_DNGFILE.toString().replace("\\", "/")))
                                .getFile());
    ...
    public void emptyFileToString() {
        ...
        File f =
                new File(
                        Objects.requireNonNull(
                                        classLoader.getResource(PATH_TO_EMPTY_DNGFILE.toString()))
                                .getFile());
        String expectedContent = "";
        String read = DslFileLoader.fileToString(f);
        assertEquals(expectedContent, read);
