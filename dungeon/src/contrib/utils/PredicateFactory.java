 ...
 * XOR, and NOT.
 *
 * <p>Each method returns a new Boolean-Supplier that evaluates the desired logical operation when
...
public class PredicateFactory {
   ...
   * @return a Boolean-Supplier that returns the result of a logical AND operation
   */
   ...
   * @param a the first boolean predicate
   * @param b the second boolean predicate
   * @return a Boolean-Supplier that returns the result of a logical OR operation
   */
   ...
   * @param a the first boolean predicate
   * @param b the second boolean predicate
   * @return a Boolean-Supplier that returns the result of a logical XOR operation
   */
   ...
   * @return a Boolean-Supplier that returns the result of the boolean predicate
   */
   ...
   *
   * @param a the boolean predicate
   * @return a Boolean-Supplier that returns the result of a logical NOT operation
   */
