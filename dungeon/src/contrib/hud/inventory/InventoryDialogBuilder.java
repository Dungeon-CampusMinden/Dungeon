 ...
 *
 * <p>It validates that the entity has an InventoryComponent and retrieves a custom title from the
 * dialog context or generates a default based on the entity's player name or entity name.
 */
public final class InventoryDialogBuilder {
  private static final DungeonLogger LOGGER = DungeonLogger.getLogger(InventoryDialogBuilder.class);
   ...
   *
   * <p>It retrieves an optional custom title from the context or generates a default title based on
   * the entity's player name or entity name. Item usage is enabled if the entity is a player.
   *
