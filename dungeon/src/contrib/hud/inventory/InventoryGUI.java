...
public class InventoryGUI extends CombinableGUI implements IInventoryHolder {
   ...
   *
   * @param context The dialog context containing the entity with the inventory component.
   * @return A new InventoryDialog instance.
   */
  public static Group buildSimple(DialogContext context) {
   ...
   *
   * @param context The dialog context containing the entities with the inventory components.
   * @return A new InventoryDialog instance.
   */
  public static Group buildDual(DialogContext context) {
    Entity entity = context.requireEntity(DialogContextKeys.ENTITY);
