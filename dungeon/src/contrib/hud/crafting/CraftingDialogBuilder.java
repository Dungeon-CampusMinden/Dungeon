 ...
 * registers crafting callbacks with the UI component, and retrieves custom titles from the dialog
 * context or generates defaults based on entity names.
 */
public final class CraftingDialogBuilder {
  private static final DungeonLogger LOGGER = DungeonLogger.getLogger(CraftingDialogBuilder.class);
   ...
   *
   * @param ctx the dialog context containing the player entity, crafting entity, and optional
   *     configuration
