...
import contrib.hud.dialogs.overlays.FreeInputDialogOverlay;
 ...
 * title, placeholder text, and button labels. Default values are used for any unspecified
 * parameters.
 */
public final class FreeInputDialogBuilder {
   ...
   *
   * <ul>
   *   <li>Title defaults to the overlay's default title
   *   <li>Prefill defaults to an empty string
   *   <li>Placeholder defaults to the overlay's default placeholder text
   *   <li>Confirm label defaults to "OK"
   *   <li>Cancel label defaults to "CANCEL"
   * </ul>
   *
