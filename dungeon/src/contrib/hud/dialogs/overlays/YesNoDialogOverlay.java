 ...
 *
 * <p>This class extends {@link BaseUiOverlay} for rendering a modal dialog box with a title,
 * descriptive text, and Yes/No buttons.
 *
 * <p>The dialog overlays the game screen and captures user input for the buttons.
 *
 * <p>The dialog's visual appearance is managed via the {@link DialogFrameRenderer} utility class,
 * which handles frame rendering, button layout, and text wrapping.
 *
 * <p>User interactions with the Yes/No buttons are relayed to registered callbacks using the {@link
 * DialogCallbackResolver}.
 *
 * <p>Primary functionality:
 *
 * <ul>
 *   <li>Render a dialog with customizable title and text
 *   <li>Capture input for Yes/No button presses
 *   <li>Trigger callbacks upon button confirmation
 *   <li>Support visibility toggling and positioning of the dialog overlay
 * </ul>
 */
