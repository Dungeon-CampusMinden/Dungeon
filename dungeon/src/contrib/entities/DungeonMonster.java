...
public class DungeonMonster {
   ...
   */
  public static final MonsterBuilder IMP = new MonsterBuilder()
    .name("Imp")
    .speed(5.0f)
    .mass(1.0f)
    .onWallHit(e -> {})
   ...
   */
  public static final MonsterBuilder ZOMBIE = new MonsterBuilder()
    .name("Zombie")
    .speed(3.2f)
    .mass(1.3f)
    .onWallHit(e -> {})
   ...
   */
  public static final MonsterBuilder OGRE = new MonsterBuilder()
    .name("Ogre")
    .speed(2.5f)
    .mass(2.5f)
    .onWallHit(e -> {})
   ...
   */
  public static final MonsterBuilder GOBLIN = new MonsterBuilder()
    .name("Goblin")
    .speed(4.2f)
    .mass(1.0f)
    .onWallHit(e -> {})
   ...
   */
  public static final MonsterBuilder ICE_ZOMBIE = new MonsterBuilder()
    .name("Ice Zombie")
    .speed(2.8f)
    .mass(1.3f)
    .onWallHit(e -> {})
   ...
   */
  public static final MonsterBuilder ORC_SHAMAN = new MonsterBuilder()
    .name("Orc Shaman")
    .speed(3.4f)
    .mass(1.2f)
    .onWallHit(e -> {})
   ...
   *
   * <p>This class uses reflection to get all public static fields of type MonsterBuilder and returns one
   * at random.
   *
