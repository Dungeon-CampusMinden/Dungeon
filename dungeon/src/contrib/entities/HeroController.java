...
public class HeroController {
  ...
  /**
   * First attempts to find an interactable entity at the specified point (e.g., mouse cursor position). If no interactable
   * entity is found or the entity is out of range, it searches within a 1-tile radius around the
   * hero.
   *
   * @param hero the hero entity attempting the interaction
   * @param point the target point where the interaction is attempted (e.g., cursor position)
   * @return an Optional containing the found entity, or Optional.empty() if no interactable entity was found within range
   */
