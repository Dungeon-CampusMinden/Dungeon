...
public final class HeroFactory {
   ...
   * corresponding {@link Tile} using {@link Game#tileAT(Point)}, which now returns an {@link
   * Optional}. If the tile is present, it attempts to find the first entity at that tile that has
   * an {@link InteractionComponent}.
   *
