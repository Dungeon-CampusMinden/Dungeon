...
/**
 * The PointRenderer class provides functionality for rendering named points and the
 * associated graphical markers and labels within the level editor.
 *
 * <p>This class is used to visually represent anchor points or markers on a dungeon level,
 * as well as highlight a held point.
 *
 * <p>Responsibilities:
 * <ul>
 *   <li>Draws named point markers with customizable colors, sizes, and labels.</li>
 *   <li>Highlights a currently held point with a distinct appearance.</li>
 *   <li>Supports rendering ghost markers for held points being moved.</li>
 * </ul>>
 *
 * <p>Features:
 * <ul>
...
final class PointRenderer {
  ...
  private void drawNamedPointMarker(
    ...
    drawMarker(g, screenCenter, markerSize, heldPoint ? HELD_POINT_MARKER_COLOR : POINT_MARKER_COLOR);
