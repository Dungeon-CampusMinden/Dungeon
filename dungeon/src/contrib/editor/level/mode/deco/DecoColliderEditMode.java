 ...
 *
 * <p>Each mode corresponds to a specific operation that can be performed
 * on the collider, such as changing the decoration or modifying its dimension
 * and position offsets.
 *
 * <p>The enum also provides methods to retrieve a display name for each mode,
 * navigate to the next mode cyclically, and determine if the mode
 * involves copying the collider to the clipboard.
 */
