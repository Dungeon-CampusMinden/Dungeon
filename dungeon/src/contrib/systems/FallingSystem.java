...
public class FallingSystem extends System {
   ...
   *
   * <p>Uses {@link Game#tileAT(Point)}, which now returns an {@link Optional}, to safely check the
   * tile at the entity's current position. If the tile exists and is an open pit, the entity will
   * be considered as falling.
   *
