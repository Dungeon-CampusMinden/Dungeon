...
/**
 * Creates a progress bar which follows the associated Entity and shows the current mana
 * percentage. *
 *
...
public final class ManaBarSystem extends System {
    ...
    private void update(final EnemyData ed) {
        ...
        ed.pb.setVisible(
                ed.dc.isVisible() && ed.mc.getCurrentAmount() != ed.mc.getMaxAmount());
    ...
    private ProgressBar createNewManaBar(PositionComponent pc) {
        ProgressBar progressBar =
                new ProgressBar(MIN, MAX, STEP_SIZE, false, defaultSkin(), "manabar");
