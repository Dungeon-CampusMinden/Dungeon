...
public final class DebugKeyboardConfig {
  ...
  public static final ConfigKey<Integer> DEBUG_RENDER_PASSTHROUGH_ALPHA =
      new ConfigKey<>(
          new String[] {"debug", "render", "passthrough_alpha"}, new ConfigIntValue(Keys.F11));
