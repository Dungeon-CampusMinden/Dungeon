 ...
 *
 * <p>If {@link HeroBuilder#ENABLE_MOUSE_MOVEMENT} is set to true, this handles the mouse movement
 * of the player, by using pathfinding to calculate the path to the mouse click.
 *
 * @see AIComponent
