...
public final class InventoryComponent implements Component {
   ...
   *
   * @param onItemAdded A {@link Consumer<Item>} that defines the action to be performed when an
   *     item is added.
   */
   ...
   *
   * @return A {@link Consumer<Item>} that defines the action performed when an item is added.
   */
   ...
   *
   * @param onItemRemoved A {@link Consumer<Item>} that defines the action to be performed when an
   *     item is removed.
   */
   ...
   *
   * @return A {@link Consumer<Item>} that defines the action performed when an item is removed.
   */
