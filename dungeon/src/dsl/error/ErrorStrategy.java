      ...
      if (nextTokens.contains(la)) {
        ...
        switch (s.getStateType()) {
          ...
          case 10: // STAR_LOOP_ENTRY
            ...
            // InputMismatchException and will call `recover` afterwards, which in turn will
            // calculate
            ...
            // determining the recovery-set. This will cause the parser to gobble up all remaining
            // tokens
            // and after that just exit the rule.
            // By not throwing an input mismatch exception here and falling through to the following
            // cases,
            // we gain the chance to resynchronize on any of the expected tokens. This is because
            // the calculation
            // of the following-set in this case (whatFollowsLoopIterationOrRule) actually contains
            // all expected tokens,
            // not only the 'normally' calculated following-set. For more information about how the
            // 'normal' follow set
