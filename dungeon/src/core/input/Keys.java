...
/**
 * Engine-agnostic keyboard key codes.
 *
 * <p>Values are aligned with libGDX Input.Keys to keep existing config files compatible.
 */
public final class Keys {
  public static final int ANY_KEY = -1;
  public static final int UNKNOWN = 0;

  // Numbers (top row on many layouts; aligned with libGDX / Android keycodes)
