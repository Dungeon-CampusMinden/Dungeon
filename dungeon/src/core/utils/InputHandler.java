...
public class InputHandler {
  ...
  /**
   * Check if a key is pressed, ignoring input if a UI element has keyboard focus (such as a text
   * field).
   *
  ...
  /**
   * Check if a key was just pressed, ignoring input if a UI element has keyboard focus (such as a
   * text field).
   *
   * @param key The key to check.
