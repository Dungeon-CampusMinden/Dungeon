 ...
 * coordinate systems. It abstracts away platform-specific input handling, allowing the engine to
 * query cursor position independently of the underlying framework.
 *
...
public interface CursorAdapter {
   ...
   *
   * <p>This method performs any necessary coordinate transformations (e.g., applying camera offset
   * and zoom) to convert the screen-space cursor position to world space.
   *
