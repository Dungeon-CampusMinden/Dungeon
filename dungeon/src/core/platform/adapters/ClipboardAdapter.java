 ...
 *
 * <p>ClipboardAdapter defines an abstraction for reading and writing to the system clipboard. It
 * provides default no-op implementations, allowing implementations to selectively support clipboard
 * functionality based on the target platform.
 *
 ...
 * </ul>
 *
 * <p>Implementations that do not support clipboard functionality can leave methods unchanged, and
...
public interface ClipboardAdapter {
   ...
   *
   * <p>Returns false by default. Implementations that support clipboard access should override this
