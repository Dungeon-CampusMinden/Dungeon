 ...
 *
 * <p>The PathfindingService provides methods to compute a path from a starting {@link Tile}
 * to a destination {@link Tile} within a given {@link ILevel}.
 *
 ...
 * <ul>
 *   <li>Determining the sequence of tiles (as a {@link TilePath}) that form the shortest,
 *   most optimal, or desired path from a start tile to an end tile.</li>
 *   <li>Supporting scenarios where no valid path exists via the use of {@link Optional}.</li>
 * </ul>
 *
...
public interface PathfindingService {
   ...
   * @return an {@link Optional} containing the computed {@link TilePath} if a valid path exists,
   *         or an empty {@link Optional} if no path can be found
   */
