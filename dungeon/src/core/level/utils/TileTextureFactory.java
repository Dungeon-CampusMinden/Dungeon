...
public class TileTextureFactory {
  ...
  private static IPath findGitterElement(LevelPart levelPart) {
    ...
    if (isWallLike(n.getLeft(),levelPart.layout) && isWallLike(n.getRight(), levelPart.layout) && isFloorLike(n.getDown(), levelPart.layout)
      || isFloorLike(n.getUp(),levelPart.layout)) {
      return new SimpleIPath("portal/gutter/gutter_horizontal");
    }

    if (isWallLike(n.getUp(),levelPart.layout) && isWallLike(n.getDown(),levelPart.layout) && isFloorLike(n.getLeft(),levelPart.layout)
  ...
  private static IPath findGlasswallElement(LevelPart levelPart) {
    Neighbors n = new Neighbors(levelPart.position, levelPart.layout);
    if (isWallLike(n.getLeft(),levelPart.layout) && isWallLike(n.getRight(),levelPart.layout) && isFloorOrDoor(n.getDown(), levelPart.layout)
      ...
      && (isFloorOrDoor(n.getLeft(), levelPart.layout) || isFloorOrDoor(n.getRight(), levelPart.layout))) {
  ...
  private static boolean isWallLike(Coordinate p, LevelElement[][] layout) {
    ...
    return e == LevelElement.WALL || e == LevelElement.PORTAL || e == LevelElement.GLASSWALL || e == LevelElement.GITTER;
  }
