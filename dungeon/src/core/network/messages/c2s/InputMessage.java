...
public record InputMessage(
   ...
   * @return the created input message
   */
  public static InputMessage castSkill(Point target) {
    return new InputMessage(Action.CAST_SKILL, new CastSkill(target));
  }
   ...
   * @return the created input message
   */
  public static InputMessage nextSkill() {
    return new InputMessage(Action.NEXT_SKILL, new SkillChange(true));
  }
   ...
   * @return the created input message
   */
  public static InputMessage prevSkill() {
    return new InputMessage(Action.PREV_SKILL, new SkillChange(false));
  }
   ...
   */
  public record CastSkill(Point target) implements Payload {
    /**
   ...
   */
  public record SkillChange(boolean nextSkill) implements Payload {}
