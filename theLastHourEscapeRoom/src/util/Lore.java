...
public class Lore {
  ...
  public static final List<BlogTab.BlogEntry> BlogEntries = List.of(
    ...
    new BlogTab.BlogEntry("Vielen Dank - aber mit Vorsicht", "Blog entry 2", List.of(new BlogTab.BlogComment("TechAnalyst", "Blog comment 1", 180), new BlogTab.BlogComment("CyberLab", "Blog comment 2", 300)))
  );
