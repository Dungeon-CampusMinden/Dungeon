...
public class StateSolarSystem extends GameState {
  ...
  public void init() {
    ...
    this.stepper.step("ui_elements", true, () -> {
    ...
    this.stepper.step("entity_sun", true, () -> {
      this.sun = new Entity();
    ...
    this.stepper.step("entity_moon", true, () -> {
