...
private Coordinate cp_stick= customPoints.get(10);
  ...
  public void onFirstTick() {
    ...
    private void setupWolf() throws IOException {
      ...
      wolf.add(new HealthComponent(10, new Consumer<Entity>() {
          @Override
      ...
      wolf.add(dc);
      wolf.add(new AIComponent(new AIChaseBehaviour(5),new RadiusWalk(9,2), new RangeTransition(9)));
    ...
    private void makePitsWater() {
        Game.allTiles(LevelElement.PIT).forEach(tile ->
                {
