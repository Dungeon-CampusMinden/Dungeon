...
public class CyberSecurity {
  ...
  private static void onSetup() {
    Game.userOnSetup(
        () -> {
          setupMusic();
          DungeonLoader.addLevel(Tuple.of("cyber", Level1.class));
          createSystems();
          try {
            createHero();
          } catch (IOException e) {
  ...
  private static void createHero() throws IOException {
    ...
    hero.fetch(DrawComponent.class).get().setVisible(false);
