...
> - **Embedded license files**: [byte-buddy-1.14.12.jar/META-INF/LICENSE](byte-buddy-1.14.12.jar/META-INF/LICENSE) 
    - [byte-buddy-1.14.12.jar/META-INF/NOTICE](byte-buddy-1.14.12.jar/META-INF/NOTICE)

**2** **Group:** `net.bytebuddy` **Name:** `byte-buddy-agent` **Version:** `1.14.12` 
> - **POM License**: Apache License, Version 2.0 - [https://www.apache.org/licenses/LICENSE-2.0.txt](https://www.apache.org/licenses/LICENSE-2.0.txt)
> - **Embedded license files**: [byte-buddy-agent-1.14.12.jar/META-INF/LICENSE](byte-buddy-agent-1.14.12.jar/META-INF/LICENSE) 
    - [byte-buddy-agent-1.14.12.jar/META-INF/NOTICE](byte-buddy-agent-1.14.12.jar/META-INF/NOTICE)
...
**4** **Group:** `com.google.code.gson` **Name:** `gson` **Version:** `2.10.1` 
...
**5** **Group:** `org.abego.treelayout` **Name:** `org.abego.treelayout.core` **Version:** `1.0.3` 
...
**6** **Group:** `org.antlr` **Name:** `antlr-runtime` **Version:** `3.5.3` 
...
**10** **Group:** `org.lwjgl` **Name:** `lwjgl-glfw` **Version:** `3.3.3` 
> - **POM Project URL**: [https://www.lwjgl.org](https://www.lwjgl.org)
> - **POM License**: BSD-3-Clause - [https://www.lwjgl.org/license](https://www.lwjgl.org/license)

**11** **Group:** `org.lwjgl` **Name:** `lwjgl-jemalloc` **Version:** `3.3.3` 
> - **POM Project URL**: [https://www.lwjgl.org](https://www.lwjgl.org)
> - **POM License**: BSD-3-Clause - [https://www.lwjgl.org/license](https://www.lwjgl.org/license)

**12** **Group:** `org.lwjgl` **Name:** `lwjgl-openal` **Version:** `3.3.3` 
> - **POM Project URL**: [https://www.lwjgl.org](https://www.lwjgl.org)
> - **POM License**: BSD-3-Clause - [https://www.lwjgl.org/license](https://www.lwjgl.org/license)

**13** **Group:** `org.lwjgl` **Name:** `lwjgl-opengl` **Version:** `3.3.3` 
> - **POM Project URL**: [https://www.lwjgl.org](https://www.lwjgl.org)
> - **POM License**: BSD-3-Clause - [https://www.lwjgl.org/license](https://www.lwjgl.org/license)

**14** **Group:** `org.lwjgl` **Name:** `lwjgl-stb` **Version:** `3.3.3` 
> - **POM Project URL**: [https://www.lwjgl.org](https://www.lwjgl.org)
> - **POM License**: BSD-3-Clause - [https://www.lwjgl.org/license](https://www.lwjgl.org/license)

## Eclipse Public License 1.0

**15** **Group:** `junit` **Name:** `junit` **Version:** `4.13.2` 
...
**16** **Group:** `org.jcraft` **Name:** `jorbis` **Version:** `0.0.17` 
...
**17** **Group:** `com.badlogicgames.jlayer` **Name:** `jlayer` **Version:** `1.0.1-gdx` 
...
**18** **Group:** `org.mockito` **Name:** `mockito-core` **Version:** `5.11.0` 
> - **POM Project URL**: [https://github.com/mockito/mockito](https://github.com/mockito/mockito)
> - **POM License**: MIT - [https://opensource.org/licenses/MIT](https://opensource.org/licenses/MIT)
> - **Embedded license files**: [mockito-core-5.11.0.jar/LICENSE](mockito-core-5.11.0.jar/LICENSE)

## New BSD License

**19** **Group:** `org.hamcrest` **Name:** `hamcrest-core` **Version:** `1.3` 
...
> - **Embedded license files**: [hamcrest-core-1.3.jar/LICENSE.txt](hamcrest-core-1.3.jar/LICENSE.txt)

## The Apache Software License, Version 2.0

**20** **Group:** `com.badlogicgames.gdx` **Name:** `gdx` **Version:** `1.12.1` 
> - **POM Project URL**: [https://github.com/libgdx/libgdx](https://github.com/libgdx/libgdx)
> - **POM License**: The Apache Software License, Version 2.0 - [http://www.apache.org/licenses/LICENSE-2.0.txt](http://www.apache.org/licenses/LICENSE-2.0.txt)

**21** **Group:** `com.badlogicgames.gdx` **Name:** `gdx-ai` **Version:** `1.8.2` 
> - **POM Project URL**: [https://github.com/libgdx/gdx-ai](https://github.com/libgdx/gdx-ai)
> - **POM License**: The Apache Software License, Version 2.0 - [http://www.apache.org/licenses/LICENSE-2.0.txt](http://www.apache.org/licenses/LICENSE-2.0.txt)

**22** **Group:** `com.badlogicgames.gdx` **Name:** `gdx-backend-lwjgl3` **Version:** `1.12.1` 
> - **POM Project URL**: [https://github.com/libgdx/libgdx](https://github.com/libgdx/libgdx)
> - **POM License**: The Apache Software License, Version 2.0 - [http://www.apache.org/licenses/LICENSE-2.0.txt](http://www.apache.org/licenses/LICENSE-2.0.txt)

**23** **Group:** `com.badlogicgames.gdx` **Name:** `gdx-freetype` **Version:** `1.12.1` 
> - **POM Project URL**: [https://github.com/libgdx/libgdx](https://github.com/libgdx/libgdx)
> - **POM License**: The Apache Software License, Version 2.0 - [http://www.apache.org/licenses/LICENSE-2.0.txt](http://www.apache.org/licenses/LICENSE-2.0.txt)

**24** **Group:** `com.badlogicgames.gdx` **Name:** `gdx-freetype-platform` **Version:** `1.12.1` 
> - **POM Project URL**: [https://github.com/libgdx/libgdx](https://github.com/libgdx/libgdx)
> - **POM License**: The Apache Software License, Version 2.0 - [http://www.apache.org/licenses/LICENSE-2.0.txt](http://www.apache.org/licenses/LICENSE-2.0.txt)

**25** **Group:** `com.badlogicgames.gdx` **Name:** `gdx-jnigen-loader` **Version:** `2.3.1` 
> - **POM Project URL**: [https://github.com/libgdx/gdx-jnigen](https://github.com/libgdx/gdx-jnigen)
> - **POM License**: The Apache Software License, Version 2.0 - [http://www.apache.org/licenses/LICENSE-2.0.txt](http://www.apache.org/licenses/LICENSE-2.0.txt)

**26** **Group:** `com.badlogicgames.gdx` **Name:** `gdx-lwjgl3-glfw-awt-macos` **Version:** `1.12.1` 
> - **POM Project URL**: [https://github.com/libgdx/libgdx](https://github.com/libgdx/libgdx)
> - **POM License**: The Apache Software License, Version 2.0 - [http://www.apache.org/licenses/LICENSE-2.0.txt](http://www.apache.org/licenses/LICENSE-2.0.txt)

**27** **Group:** `com.badlogicgames.gdx` **Name:** `gdx-platform` **Version:** `1.12.1` 
> - **POM Project URL**: [https://github.com/libgdx/libgdx](https://github.com/libgdx/libgdx)
> - **POM License**: The Apache Software License, Version 2.0 - [http://www.apache.org/licenses/LICENSE-2.0.txt](http://www.apache.org/licenses/LICENSE-2.0.txt)

## The BSD License

**28** **Group:** `org.antlr` **Name:** `ST4` **Version:** `4.3.4` 
> - **POM License**: The BSD License - [http://www.antlr.org/license.html](http://www.antlr.org/license.html)

## Unicode/ICU License

**29** **Group:** `com.ibm.icu` **Name:** `icu4j` **Version:** `72.1` 
