...
public class SignFactory {
  ...
  private static final Animation SIGN_TEXTURE =
      Animation.fromSingleImage(new SimpleIPath("objects/mailbox/mailbox_2.png")); // TODO: Change to sign texture
  ...
  public static Entity createSign(String text, String title, Point pos) throws IOException {
