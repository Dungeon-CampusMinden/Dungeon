...
public class PortalDemoLevel extends AdvancedLevel {
  ...
  protected void onFirstTick() {
    ...
    Game.add(LaserGrid.laserGrid(namedPoints.get("Grid2"), true));
    Game.add(LaserGrid.laserGrid(namedPoints.get("Grid3"), true));
    Game.add(LaserGrid.laserGrid(namedPoints.get("Grid4"), true));
    Game.add(LaserGrid.laserGrid(namedPoints.get("Grid5"), true));
    Game.add(AntiMaterialBarrier.antiMaterialBarrier(namedPoints.get("Anti1"), true));
    Game.add(AntiMaterialBarrier.antiMaterialBarrier(namedPoints.get("Anti2"), true));
    Game.add(AntiMaterialBarrier.antiMaterialBarrier(namedPoints.get("Anti3"), true));
    Game.add(AntiMaterialBarrier.antiMaterialBarrier(namedPoints.get("Anti4"), true));
    Game.add(AntiMaterialBarrier.antiMaterialBarrier(namedPoints.get("Anti5"), true));
