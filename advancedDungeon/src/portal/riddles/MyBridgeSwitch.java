 ...
 *
 * <p>Diese Klasse bestimmt, was passieren soll,
 * wenn ein Schalter eine Lichtbrücke ein- oder ausschaltet.
 *
 * <p>Die Lichtbrücke selbst wird vom Spiel gebaut –
 * du entscheidest hier nur, <b>wann sie aktiv ist</b>
 * und <b>wann nicht</b>.
 */
public class MyBridgeSwitch extends BridgeSwitch {
   ...
   *
   * <p>Hier legst du fest, was passieren soll,
   * wenn die Lichtbrücke eingeschaltet wird.
   *
   ...
   *
   * <p>Hier legst du fest, was passieren soll,
   * wenn die Lichtbrücke ausgeschaltet wird.
   *
