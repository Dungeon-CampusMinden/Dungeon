...
public class MyMonsterSort extends MonsterSort {
   ...
   *
   * HINWEIS: Verwende getHealthPoints() um die Lebenspunkte der Monster zu vergleichen.
   * Die meisten Sortieralgorithmen benötigen verschachtelte Schleifen (eine äußere und eine innere) um Objekte zu vergleichen.
   *
   * WICHTIG: Immer wenn du zwei Monster im Array tauschst, musst du auch ihre visuellen Positionen im Spiel tauschen! Nutze dafür die swapPosition() Methode.
   *
