...
public class TractorBeamComponent extends BeamComponent {
  ...
  @Override
  public void extend(Direction direction, Point from, Component component) {
    TractorBeamFactory.extendTractorBeam(direction, from, this.tractorBeamEntities, component);
  }
