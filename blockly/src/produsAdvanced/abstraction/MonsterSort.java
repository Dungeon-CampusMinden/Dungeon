 ...
 * Subclasses must override the {@code sortMonsters} method to implement the desired sorting behavior.
 */
public abstract class MonsterSort {
   ...
   *
   * <p>The method returns an array of sorted health values.
   * If a subclass does not implement this method, an {@link UnsupportedOperationException} is thrown.
   *
