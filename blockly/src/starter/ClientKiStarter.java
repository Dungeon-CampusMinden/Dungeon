...
public class ClientKiStarter {
  ...
  private static void onSetup() {
    Game.userOnSetup(
        () -> {
          DevDungeonLoader.addLevel(Tuple.of("kilevel", MazeLevel.class));
          createSystems();
          ...
          DevDungeonLoader.afterAllLevels(ClientKiStarter::startRoomBasedLevel);
  ...
  private static void startRoomBasedLevel() {
    ...
    LevelSystem levelSystem = (LevelSystem) ECSManagment.systems().get(LevelSystem.class);
    levelSystem.onEndTile(ClientKiStarter::startRoomBasedLevel); // restart the level -> endless loop
  }
