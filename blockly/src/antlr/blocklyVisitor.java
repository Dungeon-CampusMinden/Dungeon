...
public interface blocklyVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by the {@code Parenthese_Expr} labeled alternative in {@link
   * blocklyParser#expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code Compare_Expr} labeled alternative in {@link
   * blocklyParser#expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code Logic_Expr} labeled alternative in {@link
   * blocklyParser#expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code Atom_Expr} labeled alternative in {@link
   * blocklyParser#expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
  ...
  /**
   * Visit a parse tree produced by the {@code Not_Expr} labeled alternative in {@link
   * blocklyParser#expr}.
   *
   * @param ctx the parse tree
   * @return the visitor result
