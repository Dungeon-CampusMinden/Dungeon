...
/**
 * The `CollisionManifold` class provides functionality to register and calculate collision contact
 * points between different types of colliders in the physics engine.
 */
public class CollisionManifold {
  ...
  private static final Map<
          ...
          Map<
              Class<? extends Collider>,
              IFunction4P<Set<Vector3f>, Collider, Collider, Vector3f, Float>>>
      functions = new HashMap<>();

  static {
    registerCalculationFunction(
        BoxCollider.class, BoxCollider.class, CollisionManifoldPolyhedron::calculateContactPoints);
  }
   ...
   */
  public static void registerCalculationFunction(
      Class<? extends Collider> c1,
      Class<? extends Collider> c2,
   ...
   */
  public static Set<Vector3f> calculateContactPoints(
      Collider cA, Collider cB, Vector3f normal, float depth) {
    IFunction4P<Set<Vector3f>, Collider, Collider, Vector3f, Float> function;
    ...
    LOGGER.warn(
        "No collision calculation function found for colliders {} and {}",
        cA.getClass(),
        cB.getClass());
    return Set.of();
  }
