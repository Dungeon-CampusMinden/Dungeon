...
/**
 * A UI component that adds scroll functionality to a UI element. The UIComponentScrollable class
 * allows setting and getting a function that will be executed when the UI element is scrolled.
 */
public class UIComponentScrollable extends UIComponent<UIComponentScrollable> {
   ...
   */
  public UIComponentScrollable onScroll(IVoidFunction3P<UIElement<?>, Integer, Integer> onScroll) {
