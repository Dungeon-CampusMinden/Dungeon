...
/**
 * Represents a window move event. This class extends the Event class and is used to signal that a
 * game window has been moved.
 */
public class WindowMoveEvent extends Event implements Cancelable {
  ...
  /**
   * Sets the cancel state of the window move event. This method does not have any effect, as the
   * window move event cannot be canceled.
   *
