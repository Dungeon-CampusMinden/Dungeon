...
/**
 * The `IFunction4P` interface represents a functional interface with a single method `run` that executes a function with four parameters and returns a result.
 *
