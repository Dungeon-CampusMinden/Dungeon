...
- `engine.network.input.InputCommandRouter`
- `engine.network.messages.c2s.InputMessage`
...
- `game/src/feature/entities/HeroController.java` (static `registerDefaultInputHandlers()`).
