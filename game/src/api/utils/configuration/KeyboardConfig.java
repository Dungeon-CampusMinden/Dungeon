package api.utils.configuration;

import com.badlogic.gdx.Input;
import api.utils.configuration.values.ConfigIntValue;
...
public class KeyboardConfig {
    ...
    public static final ConfigKey<Integer> FIRST_SKILL =
            new ConfigKey<>(new String[] {"stuff/skill", "first"}, new ConfigIntValue(Input.Keys.Q));
    public static final ConfigKey<Integer> SECOND_SKILL =
            new ConfigKey<>(new String[] {"stuff/skill", "second"}, new ConfigIntValue(Input.Keys.R));
}
