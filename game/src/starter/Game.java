...
public class Game extends ScreenAdapter implements IOnLevelLoader {
    ...
    private EventResponsiveDialogue eventResponsiveDialogue;
     ...
     * @param systems ECS_Systems, which control components of all entities in game loop
     */
    private void deleteEventResponsiveDialogue( List<AbstractController<?>> controller, SystemController systems) {
     ...
     * @param systems ECS_Systems, which control components of all entities in game loop
     */
    private void generateEventResponsiveDialogue( List<AbstractController<?>> controller, SystemController systems) {
