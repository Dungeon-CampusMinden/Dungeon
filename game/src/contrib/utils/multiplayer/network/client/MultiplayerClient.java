...
public class MultiplayerClient extends Listener implements IClient {
    ...
    public void received(Connection connection, Object object) {
        ...
        } else if (object instanceof AuthenticationRequest) {
            for (IClientObserver observer : observers) {
                observer.onAuthenticationRequestReceived();
            }
        ...
        } else if (object instanceof OnAuthenticatedEvent onAuthenticatedEvent) {
            for (IClientObserver observer : observers) {
                observer.onAuthenticatedEventReceived(onAuthenticatedEvent.assignedClientID());
            }
        }
    }
