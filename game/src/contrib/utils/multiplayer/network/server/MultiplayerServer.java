package contrib.utils.multiplayer.network.server;
...
import contrib.utils.multiplayer.network.packages.NetworkSetup;
...
import contrib.utils.multiplayer.network.packages.request.PingRequest;
...
public class MultiplayerServer extends Listener implements IServer {
    ...
    public void received(Connection connection, Object object) {
        ...
        } else if (object instanceof AuthenticationResponse initServerRequest) {
            for (IServerObserver observer : observers) {
                observer.onAuthenticationResponseReceived(connection.getID(), initServerRequest);
            }
    ...
    public void disconnectClient(final int clientID) {
        final Connection[] currentConnections = server.getConnections();
        final Connection toBeRemoved =
