...
public interface ILevel extends IndexedGraph<Tile> {
     ...
     *
     * <p>This method selects a random tile with the element type {@link LevelElement#FLOOR} and
     * sets it as the start tile for the level.
     */
    ...
    /**
     * Generates a String representation of the level layout using specific symbols for different
     * tile types.
     *
    ...
    /**
     * Starts the indexed A* pathfinding algorithm and returns a path between the specified start
     * and end tiles.
     *
     ...
     * @return The tile at the specified coordinate, or null if there is no tile or the coordinate
     *     is out of bounds.
     */
     ...
     *
     * <p>The method internally calls {@link #randomTile()} to obtain a random tile and then
     * retrieves its position.
     *
     ...
     * {@link Point}.
     *
     * <p>The method internally calls {@link #randomTile(LevelElement)} to obtain a random tile of
     * the specified type and then retrieves its position.
     *
     * @param elementType Type of the tile for which to retrieve the position.
     * @return The position of a randomly selected tile of the specified type in the level as a
     *     {@link Point}.
     */
