...
import core.hud.menus.startmenu.IStartMenuObserver;
import core.hud.menus.startmenu.StartMenu;
...
public class Game extends ScreenAdapter implements IOnLevelLoader, IStartMenuObserver, IMultiplayer {
    ...
    protected void frame() {
        ...
        if (Gdx.input.isKeyJustPressed(Input.Keys.P) && !startMenu.isVisible()) UITools.showInfoText();
