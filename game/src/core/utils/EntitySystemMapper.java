...
public final class EntitySystemMapper {
     ...
     * System#triggerOnAdd(Entity)} method of the System will be called for each existing Entity
     * that fulfills the filter rules.
     *
     ...
     * @return true if the System was removed successfully, false if the System was not present in
     *     the EntitySystemMapper and no removal was performed.
     */
     ...
     * @return true if the Entity was removed successfully, false if the Entity was not present in
     *     the EntitySystemMapper and no removal was performed.
     */
