...
public enum SystemRecoveryLearningStep {
  ENERGY_ARRAY("energy-array", "riddle1", "energy-array", TerminalStep.ENERGY_ARRAY),
  ...
  MODULE_ARRAY("module-array", "riddle2", "module-storage", TerminalStep.MODULE_ARRAY),
  ...
  INVENTORY_COUNT("inventory-count", "riddle3", "inventory-scanner", TerminalStep.INVENTORY_COUNT),
  ROOM3_DOOR_CODE("room3-door-code", "riddle3", "inventory-scanner"),
  TRANSPORT_ARRAY("transport-array", "riddle4", "transport-storage", TerminalStep.TRANSPORT_ARRAY),
  ...
  MANUAL_SORTING("manual-sorting", "riddle5", "manual-sorting"),
  BUBBLE_SORT_CONDITION("bubble-sort-condition", "riddle6", "bubble-sort"),
  BUBBLE_SORT_MACHINE("bubble-sort-machine", "riddle6", "bubble-sort"),
  ARCHIVE_ACCESS("archive-access", "riddle7", "data-archive"),
  ARCHIVE_ARRAYS("archive-arrays", "riddle7", "data-archive", TerminalStep.ARCHIVE_ARRAYS),
  STORAGE_ARRAY("storage-array", "riddle8", "two-dimensional-storage", TerminalStep.STORAGE_ARRAY),
  STORAGE_VALUES(
      "storage-values", "riddle8", "two-dimensional-storage", TerminalStep.STORAGE_VALUES),
  SEARCH_PROGRAM("search-program", "riddle9", "search-robot", TerminalStep.SEARCH_PROGRAM),
  SEARCH_ROBOT_RUN("search-robot-run", "riddle9", "search-robot"),
  SYSTEM_CORE_ACCESS("system-core-access", "riddle10", "system-core"),
  ...
  SystemRecoveryLearningStep(String hintKey, String riddleKey, String puzzleId) {
    this(hintKey, riddleKey, puzzleId, null);
  }
