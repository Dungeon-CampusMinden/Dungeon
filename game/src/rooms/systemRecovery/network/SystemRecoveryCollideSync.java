...
import feature.collision.Hitbox;
import feature.collision.Hitcircle;
...
final class SystemRecoveryCollideSync {

  static final String METADATA_COLLIDER_TYPE = "systemRecovery.collider.type";
  static final String METADATA_COLLIDER_WIDTH = "systemRecovery.collider.width";
  static final String METADATA_COLLIDER_HEIGHT = "systemRecovery.collider.height";
  static final String METADATA_COLLIDER_OFFSET_X = "systemRecovery.collider.offset.x";
  static final String METADATA_COLLIDER_OFFSET_Y = "systemRecovery.collider.offset.y";
  static final String METADATA_COLLIDER_POSITION_X = "systemRecovery.collider.position.x";
  static final String METADATA_COLLIDER_POSITION_Y = "systemRecovery.collider.position.y";
  static final String METADATA_COLLIDER_SCALE_X = "systemRecovery.collider.scale.x";
  static final String METADATA_COLLIDER_SCALE_Y = "systemRecovery.collider.scale.y";
  static final String METADATA_COLLIDER_SOLID = "systemRecovery.collider.isSolid";

  private static final String TYPE_HITBOX = "hitbox";
  private static final String TYPE_HITCIRCLE = "hitcircle";
  private static final DungeonLogger LOGGER =
      DungeonLogger.getLogger(SystemRecoveryCollideSync.class);

  private SystemRecoveryCollideSync() {}
  ...
  private static Map<String, String> metadataOf(CollideComponent collideComponent) {
