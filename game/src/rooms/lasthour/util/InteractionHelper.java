 ...
 * feature.entities.HeroController#findInteractable}, which uses the same {@link
...
public final class InteractionHelper {
   ...
   *
   * <p>Uses the same algorithm as {@link feature.entities.HeroController#findInteractable} so that
  ...
  public static Optional<Entity> findInteractTarget(Entity hero) {
    return findInteractTarget(hero, CursorUtils.positionInWorld());
  }
