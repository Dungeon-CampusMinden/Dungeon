...
final class GameOfGamesCollideSync {

  static final String METADATA_COLLIDER_TYPE = "gog.collider.type";
  static final String METADATA_COLLIDER_WIDTH = "gog.collider.width";
  static final String METADATA_COLLIDER_HEIGHT = "gog.collider.height";
  static final String METADATA_COLLIDER_OFFSET_X = "gog.collider.offset.x";
  static final String METADATA_COLLIDER_OFFSET_Y = "gog.collider.offset.y";
  static final String METADATA_COLLIDER_POSITION_X = "gog.collider.position.x";
  static final String METADATA_COLLIDER_POSITION_Y = "gog.collider.position.y";
  static final String METADATA_COLLIDER_SCALE_X = "gog.collider.scale.x";
  static final String METADATA_COLLIDER_SCALE_Y = "gog.collider.scale.y";
  static final String METADATA_COLLIDER_SOLID = "gog.collider.isSolid";

  private static final String TYPE_HITBOX = "hitbox";
  private static final String TYPE_HITCIRCLE = "hitcircle";
  private static final DungeonLogger LOGGER = DungeonLogger.getLogger(GameOfGamesCollideSync.class);

  private GameOfGamesCollideSync() {}
