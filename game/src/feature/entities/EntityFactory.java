...
import feature.interaction.DropItemsInteraction;
...
public final class EntityFactory {
   ...
   *
   * <p>It will have a {@link CameraComponent}, {@link engine.components.PlayerComponent}. {@link
   * PositionComponent}, {@link VelocityComponent} {@link engine.components.DrawComponent}, {@link
   * feature.components.CollideComponent} and {@link HealthComponent}.
   *
   * @return A new Entity.
   */
   ...
   * engine.components.DrawComponent}, {@link feature.components.CollideComponent} and {@link
   * feature.components.InventoryComponent}. It will use the {@link DropItemsInteraction} on
   * interaction.
   *
   * @return A new Entity.
   */
  ...
  public static Entity newMovingFireballSentry(
    ...
    return SentryFactory.projectileLauncherSentry(
        ...
        b,
        shootDirection,
        new FireballSkill(SkillTools::playerPositionAsPoint, cooldown, range, false),
        range,
        false);
  }
  ...
  public static Entity newMovingArrowSentry(
    ...
    return SentryFactory.projectileLauncherSentry(
        ...
        b,
        shootDirection,
        new BowSkill(SkillTools::playerPositionAsPoint, cooldown, range, false),
        range,
        false);
  }
  ...
  public static Entity newMovingFireballWallSentry(
    ...
    return SentryFactory.projectileLauncherSentry(
        ...
        b,
        shootDirection,
        new FireballSkill(SkillTools::playerPositionAsPoint, cooldown, range, true),
        range,
        true);
  }
  ...
  public static Entity newMovingArrowWallSentry(
    ...
    return SentryFactory.projectileLauncherSentry(
        ...
        b,
        shootDirection,
        new BowSkill(SkillTools::playerPositionAsPoint, cooldown, range, true),
        range,
        true);
  }
