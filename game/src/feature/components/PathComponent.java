 ...
 * GraphPath} of {@link Tile}s. The PathComponent is used by the {@link feature.systems.PathSystem}
 * to move entities along the path. The path is generated by the {@link feature.systems.AISystem},
 * which uses the {@link feature.ai.AIUtils} class to calculate the path.
 *
 * @see AIComponent
 * @see feature.systems.AISystem
 * @see engine.components.PlayerComponent
 */
