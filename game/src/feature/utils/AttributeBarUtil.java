...
import static feature.hud.UIUtils.defaultSkin;
 ...
 * using the standard entity ID system via {@link engine.utils.EntityIdProvider}.
 */
public final class AttributeBarUtil {
  ...
  public static void addBarToEntity(
      Entity entity,
      feature.components.BarDisplayable barDisplayable,
      Map<Class<? extends feature.components.BarDisplayable>, ProgressBar> barMapping,
