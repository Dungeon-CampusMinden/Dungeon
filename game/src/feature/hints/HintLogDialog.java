...
public final class HintLogDialog {
  ...
  static {
    DialogFactory.register(HintDialogType.SIMPLE_HINT, HintLogDialog::createHintDialog);
  }
  ...
  private static Entity showHintLog(HintLogComponent log, int index, int... targetEntityIds) {
    ...
    DialogContext context =
        DialogContext.builder()
            .type(HintDialogType.SIMPLE_HINT)
            .put("escapeRoom/hint", hint)
            .put("hintIndex", index)
            .build();
  ...
  private static Group createHintDialog(DialogContext context) {
    ...
    if (Game.isHeadless()) {
      Hint hint = context.require("escapeRoom/hint", Hint.class);
