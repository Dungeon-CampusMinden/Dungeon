...
import engine.sound.SoundAsset;
import engine.sound.parser.IAudioParser;
import engine.sound.parser.WavAudioParser;
 ...
 * "game/assets/sounds" directory, parses metadata, and uses AssetManager for loading. Suitable for
 * client-side audio; for server, use {@link NoSoundPlayer}.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class GdxSoundPlayer implements ISoundPlayer {
   ...
   * "game/assets/sounds" directory. Sounds are lazy loaded when first played.
   *
