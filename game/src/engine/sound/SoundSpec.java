 ...
 *
 * <p>Used inside {@link engine.components.SoundComponent}. Instances are immutable and created
 * using the {@link Builder} pattern.
 *
 * <p>Example usage:
 *
 * <pre>{@code
 ...
 *     all clients.
 * @see engine.components.SoundComponent
 * @see engine.sound.AudioApi
 */
public record SoundSpec(
  ...
  public static final class Builder {
     ...
     *
     * <p><b>Note:</b> This is typically set automatically by {@link engine.sound.AudioApi} and
     * should not be set manually in most cases.
     *
