 ...
 * engine project and another for an implementing project.
 *
...
public class Localization {
  ...
  /** Base directory of the engine translation files, registered for every language by default. */
  ...
  private Localization() {
    // Register the engine translation file (e.g. "language/de.json") for every language by default.
   ...
   *
   * <p>This enables multiple translation sources per language, e.g. one file with the engine
