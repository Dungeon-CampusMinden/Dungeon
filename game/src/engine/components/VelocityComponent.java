 ...
 *
 * <p>The velocity system (e.g., {@link engine.systems.VelocitySystem}) is responsible for
 * integrating these forces to update the velocity and move the entity accordingly.
 *
