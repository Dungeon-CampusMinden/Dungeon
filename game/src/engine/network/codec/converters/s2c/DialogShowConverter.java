...
import engine.network.proto.common.DialogChoiceOption;
import engine.network.proto.common.DialogChoiceOptionList;
import engine.network.proto.common.IntList;
import engine.network.proto.common.StringList;
import engine.network.proto.s2c.DialogAttribute;
...
public final class DialogShowConverter
    implements MessageConverter<DialogShowMessage, engine.network.proto.s2c.DialogShowMessage> {
  private static final byte WIRE_TYPE_ID = 9;

  @Override
  public engine.network.proto.s2c.DialogShowMessage toProto(DialogShowMessage message) {
    return toProto(message.context(), message.canBeClosed());
  }

  @Override
  public DialogShowMessage fromProto(engine.network.proto.s2c.DialogShowMessage proto) {
  ...
  @Override
  public Class<engine.network.proto.s2c.DialogShowMessage> protoType() {
    return engine.network.proto.s2c.DialogShowMessage.class;
  }

  @Override
  public Parser<engine.network.proto.s2c.DialogShowMessage> parser() {
    return engine.network.proto.s2c.DialogShowMessage.parser();
  }
  ...
  private static engine.network.proto.s2c.DialogShowMessage toProto(
      DialogContext context, boolean canBeClosed) {
    Objects.requireNonNull(context, "context");
    engine.network.proto.s2c.DialogShowMessage.Builder builder =
        engine.network.proto.s2c.DialogShowMessage.newBuilder()
  ...
  private static DialogContext fromDialogProto(engine.network.proto.s2c.DialogShowMessage proto) {
