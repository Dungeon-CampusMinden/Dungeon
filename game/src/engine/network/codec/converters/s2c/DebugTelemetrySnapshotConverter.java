...
public final class DebugTelemetrySnapshotConverter
    implements MessageConverter<
        DebugTelemetrySnapshot, engine.network.proto.s2c.DebugTelemetrySnapshot> {
  private static final byte WIRE_TYPE_ID = 25;

  @Override
  public engine.network.proto.s2c.DebugTelemetrySnapshot toProto(DebugTelemetrySnapshot message) {
    engine.network.proto.s2c.DebugTelemetrySnapshot.Builder builder =
        engine.network.proto.s2c.DebugTelemetrySnapshot.newBuilder()
  ...
  @Override
  public DebugTelemetrySnapshot fromProto(engine.network.proto.s2c.DebugTelemetrySnapshot proto) {
  ...
  @Override
  public Class<engine.network.proto.s2c.DebugTelemetrySnapshot> protoType() {
    return engine.network.proto.s2c.DebugTelemetrySnapshot.class;
  }

  @Override
  public Parser<engine.network.proto.s2c.DebugTelemetrySnapshot> parser() {
    return engine.network.proto.s2c.DebugTelemetrySnapshot.parser();
  }
  ...
  private static engine.network.proto.s2c.DebugTelemetryClient toProto(
      DebugTelemetrySnapshot.Client client) {
    return engine.network.proto.s2c.DebugTelemetryClient.newBuilder()
  ...
  private static DebugTelemetrySnapshot.Client fromProto(
      engine.network.proto.s2c.DebugTelemetryClient proto) {
