...
public final class CommonProtoConverters {
   ...
   */
  public static engine.network.proto.common.Point toProto(Point point) {
    return engine.network.proto.common.Point.newBuilder().setX(point.x()).setY(point.y()).build();
  }
   ...
   */
  public static Point fromProto(engine.network.proto.common.Point proto) {
   ...
   */
  public static engine.network.proto.common.Coordinate toProto(Coordinate coordinate) {
    return engine.network.proto.common.Coordinate.newBuilder()
        .setX(coordinate.x())
        .setY(coordinate.y())
        .build();
  }
   ...
   */
  public static Coordinate fromProto(engine.network.proto.common.Coordinate proto) {
   ...
   */
  public static engine.network.proto.common.Vector2 toProto(Vector2 vector) {
    return engine.network.proto.common.Vector2.newBuilder()
        .setX(vector.x())
        .setY(vector.y())
        .build();
  }
   ...
   */
  public static Vector2 fromProto(engine.network.proto.common.Vector2 proto) {
   ...
   */
  public static engine.network.proto.common.PositionInfo toProto(PositionComponent component) {
    return engine.network.proto.common.PositionInfo.newBuilder()
   ...
   */
  public static PositionComponent fromProto(engine.network.proto.common.PositionInfo proto) {
   ...
   */
  public static engine.network.proto.common.Direction toProto(Direction direction) {
    return switch (direction) {
      case UP -> engine.network.proto.common.Direction.DIRECTION_UP;
      case DOWN -> engine.network.proto.common.Direction.DIRECTION_DOWN;
      case LEFT -> engine.network.proto.common.Direction.DIRECTION_LEFT;
      case RIGHT -> engine.network.proto.common.Direction.DIRECTION_RIGHT;
      case NONE -> engine.network.proto.common.Direction.DIRECTION_NONE;
    };
  }
   ...
   */
  public static Direction fromProto(engine.network.proto.common.Direction proto) {
    return switch (proto) {
   ...
   */
  public static engine.network.proto.common.SoundSpec toProto(SoundSpec spec) {
   ...
   */
  public static SoundSpec fromProto(engine.network.proto.common.SoundSpec proto) {
   ...
   */
  public static engine.network.proto.s2c.DrawInfo toProto(DrawInfoData drawInfo) {
    if (drawInfo == null) {
    ...
    engine.network.proto.s2c.DrawInfo.Builder builder =
        engine.network.proto.s2c.DrawInfo.newBuilder()
    ...
    if (animationName != null && !animationName.isEmpty()) {
      ...
      builder.setCurrentAnimation(
          engine.network.proto.s2c.AnimationInfo.newBuilder()
    ...
    builder.setAnimationConfig(
        engine.network.proto.s2c.AnimationConfigInfo.newBuilder()
    ...
    if (spritesheetConfig != null) {
      builder.setSpritesheetConfig(
          engine.network.proto.s2c.SpritesheetConfigInfo.newBuilder()
   ...
   */
  public static DrawInfoData fromProto(engine.network.proto.s2c.DrawInfo proto) {
    ...
    if (proto.hasCurrentAnimation()) {
      engine.network.proto.s2c.AnimationInfo animationInfo = proto.getCurrentAnimation();
    ...
    engine.network.proto.s2c.AnimationConfigInfo animationConfigInfo = proto.getAnimationConfig();
    ...
    if (proto.hasSpritesheetConfig()) {
      engine.network.proto.s2c.SpritesheetConfigInfo spritesheetConfigInfo =
    ...
    if (proto.getStatesCount() > 0) {
      ...
      for (engine.network.proto.s2c.DrawStateInfo stateInfo : proto.getStatesList()) {
  ...
  private static engine.network.proto.s2c.DrawStateInfo toProtoStateInfo(
    ...
    engine.network.proto.s2c.DrawStateInfo.Builder builder =
        engine.network.proto.s2c.DrawStateInfo.newBuilder()
  ...
  private static engine.network.proto.s2c.StateAnimationInfo toProtoStateAnimation(
    ...
    engine.network.proto.s2c.StateAnimationInfo.Builder builder =
        engine.network.proto.s2c.StateAnimationInfo.newBuilder()
            .setTexturePath(texturePath)
            .setAnimationConfig(
                engine.network.proto.s2c.AnimationConfigInfo.newBuilder()
                    .setFramesPerSprite(animationConfig.framesPerSprite())
  ...
  private static engine.network.proto.s2c.DrawStateType toProtoStateType(
      DrawInfoData.StateType stateType) {
    if (stateType == null) {
      return engine.network.proto.s2c.DrawStateType.DRAW_STATE_TYPE_BASIC;
    }
    return switch (stateType) {
      case BASIC -> engine.network.proto.s2c.DrawStateType.DRAW_STATE_TYPE_BASIC;
      case SIMPLE_DIRECTIONAL ->
          engine.network.proto.s2c.DrawStateType.DRAW_STATE_TYPE_SIMPLE_DIRECTIONAL;
      case DIRECTIONAL -> engine.network.proto.s2c.DrawStateType.DRAW_STATE_TYPE_DIRECTIONAL;
    };
  }

  private static DrawInfoData.StateData fromProtoStateInfo(
      engine.network.proto.s2c.DrawStateInfo proto) {
  ...
  private static DrawInfoData.StateAnimationData fromProtoStateAnimation(
      engine.network.proto.s2c.StateAnimationInfo proto) {
    if (proto.getTexturePath().isEmpty()) {
  ...
  private static DrawInfoData.StateType fromProtoStateType(
      engine.network.proto.s2c.DrawStateType proto) {
    return switch (proto) {
   ...
   */
  public static engine.network.proto.s2c.PlayerInfo toProto(PlayerComponent component) {
    return engine.network.proto.s2c.PlayerInfo.newBuilder()
   ...
   */
  public static PlayerComponent fromProto(engine.network.proto.s2c.PlayerInfo proto) {
   ...
   */
  public static engine.network.proto.common.Item toProto(Item item) {
   ...
   * @return the protobuf item
   */
  public static engine.network.proto.common.Item toProto(ItemState itemState) {
    engine.network.proto.common.Item.Builder builder =
        engine.network.proto.common.Item.newBuilder()
   ...
   */
  public static Item fromProto(engine.network.proto.common.Item proto) {
   ...
   */
  public static ItemState itemStateFromProto(engine.network.proto.common.Item proto) {
