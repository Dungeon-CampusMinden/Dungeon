...
public class CommonProtoConvertersTest {
  ...
  public void testPointRoundTrip() {
    ...
    engine.network.proto.common.Point protoPoint = CommonProtoConverters.toProto(point);
  ...
  public void testVector2RoundTrip() {
    ...
    engine.network.proto.common.Vector2 protoVector = CommonProtoConverters.toProto(vector);
  ...
  public void testCoordinateRoundTrip() {
    ...
    engine.network.proto.common.Coordinate protoCoordinate =
  ...
  public void testDirectionToProto() {
    assertEquals(
        engine.network.proto.common.Direction.DIRECTION_UP,
        CommonProtoConverters.toProto(Direction.UP));
    assertEquals(
        engine.network.proto.common.Direction.DIRECTION_DOWN,
        CommonProtoConverters.toProto(Direction.DOWN));
    assertEquals(
        engine.network.proto.common.Direction.DIRECTION_LEFT,
        CommonProtoConverters.toProto(Direction.LEFT));
    assertEquals(
        engine.network.proto.common.Direction.DIRECTION_RIGHT,
        CommonProtoConverters.toProto(Direction.RIGHT));
    assertEquals(
        engine.network.proto.common.Direction.DIRECTION_NONE,
  ...
  public void testDirectionFromProto() {
    assertEquals(
        Direction.UP,
        CommonProtoConverters.fromProto(engine.network.proto.common.Direction.DIRECTION_UP));
    assertEquals(
        Direction.DOWN,
        CommonProtoConverters.fromProto(engine.network.proto.common.Direction.DIRECTION_DOWN));
    assertEquals(
        Direction.LEFT,
        CommonProtoConverters.fromProto(engine.network.proto.common.Direction.DIRECTION_LEFT));
    assertEquals(
        Direction.RIGHT,
        CommonProtoConverters.fromProto(engine.network.proto.common.Direction.DIRECTION_RIGHT));
    assertEquals(
        Direction.NONE,
        CommonProtoConverters.fromProto(engine.network.proto.common.Direction.DIRECTION_NONE));
    assertEquals(
        Direction.NONE,
        CommonProtoConverters.fromProto(
            engine.network.proto.common.Direction.DIRECTION_UNSPECIFIED));
    assertEquals(
        Direction.NONE,
        CommonProtoConverters.fromProto(engine.network.proto.common.Direction.UNRECOGNIZED));
  }
  ...
  public void testPositionComponentRoundTrip() {
    ...
    engine.network.proto.common.PositionInfo proto = CommonProtoConverters.toProto(component);
    assertEquals(1.5f, proto.getPosition().getX(), DELTA);
    assertEquals(-2.0f, proto.getPosition().getY(), DELTA);
    assertEquals(engine.network.proto.common.Direction.DIRECTION_RIGHT, proto.getViewDirection());
  ...
  public void testSoundSpecRoundTrip() {
    ...
    engine.network.proto.common.SoundSpec protoSpec = CommonProtoConverters.toProto(spec);
  ...
  public void testDrawInfoRoundTrip_withSpritesheetConfig() {
    ...
    engine.network.proto.s2c.DrawInfo proto = CommonProtoConverters.toProto(drawInfo);
