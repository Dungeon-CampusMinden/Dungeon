...
public class TileLevelTest {
    ...
    public void test_levelCTOR_Tiles() {
        Tile[][] tileLayout =
                new Tile[][] {
                    {
                        new WallTile("", new Coordinate(0, 0), DesignLabel.DEFAULT),
                        new FloorTile("", new Coordinate(1, 0), DesignLabel.DEFAULT)
                    },
                    {
                        new WallTile("", new Coordinate(0, 1), DesignLabel.DEFAULT),
                        new ExitTile("", new Coordinate(1, 1), DesignLabel.DEFAULT)
                    }
                };
    ...
    public void test_levelCTOR_TilesNoExit() {
        Tile[][] tileLayout =
                new Tile[][] {
                    ...
                    {
                        new WallTile("", new Coordinate(0, 1), DesignLabel.DEFAULT),
                        new FloorTile("", new Coordinate(1, 1), DesignLabel.DEFAULT)
                    }
                };
        TileLevel tileLevel = new TileLevel(tileLayout);
        Tile[][] layout = tileLevel.layout();
    ...
    public void test_findPath_onlyOnePathPossible() {
        ...
        for (int x = 0; x < 3; x++) {
            for (int y = 0; y < 3; y++) {
                layout[y][x] = new FloorTile("", new Coordinate(x, y), DesignLabel.DEFAULT);
            }
        }
        layout[1][1] = new WallTile("", new Coordinate(1, 1), DesignLabel.DEFAULT);
        layout[0][1] = new WallTile("", new Coordinate(1, 0), DesignLabel.DEFAULT);
        layout[0][2] = new ExitTile("", new Coordinate(2, 0), DesignLabel.DEFAULT);
    ...
    public void test_findPath_endPositionNotAccessible() {
        ...
        layout[2][1] = new WallTile("", new Coordinate(1, 2), DesignLabel.DEFAULT);
        TileLevel tileLevel = new TileLevel(layout);
        var start = tileLevel.tileAt(layout[0][1].coordinate());
        var end = tileLevel.tileAt(layout[2][1].coordinate());
    ...
    public void test_addTile_FloorTile() {
        ...
        level.addTile(tile);
        assertTrue(
                "tile needs to be added to specific Tile list", level.floorTiles().contains(tile));
    ...
    public void test_addTile_ExitTile() {
        ...
        level.addTile(tile);
        assertTrue(
                "tile needs to be added to specific Tile list", level.exitTiles().contains(tile));
        assertEquals(level.getNodeCount() - 1, tile.index());
        assertTrue(
                "All neighbouring tiles need to be informed about the new tile",
                level.floorTiles().stream()
    ...
    public void test_addTile_DoorTile() {
        ...
        level.addTile(tile);
        assertTrue(
                "tile needs to be added to specific Tile list", level.doorTiles().contains(tile));
        assertEquals(level.getNodeCount() - 1, tile.index());
        assertTrue(
                "All neighbouring tiles need to be informed about the new tile",
                level.floorTiles().stream()
    ...
    public void test_addTile_SkipTile() {
        ...
        level.addTile(tile);
        assertTrue(
                "tile needs to be added to specific Tile list", level.skipTiles().contains(tile));
    ...
    public void test_addTile_WallTile() {
        ...
        level.addTile(tile);
        assertTrue(
                "tile needs to be added to specific Tile list", level.wallTiles().contains(tile));
        assertEquals(0, tile.index());
        assertTrue(
                "All neighbouring tiles need to be informed about the new tile",
                level.floorTiles().stream()
    ...
    public void test_addTile_HoleTile() {
        ...
        level.addTile(tile);
        assertTrue(
                "tile needs to be added to specific Tile list", level.holeTiles().contains(tile));
        assertEquals(0, tile.index());
        assertTrue(
                "All neighbouring tiles need to be informed about the new tile",
                level.floorTiles().stream()
