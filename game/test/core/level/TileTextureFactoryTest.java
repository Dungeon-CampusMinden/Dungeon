...
public class TileTextureFactoryTest {
  ...
  /**
   * Level Element WALL should get "wall_top" texture if below is FLOOR/HOLE, and it is not an inner
   * corner or cross.
   */
  @Test
  ...
  /**
   * Level Element WALL should get "wall_outer_corner_upper_left" texture if bottom right is FLOOR,
   * below is WALL and right is WALL.
   */
  @Test
  ...
  /**
   * Level Element WALL should get "wall_outer_corner_upper_right" texture if bottom left is FLOOR,
   * below is WALL and left is WALL.
   */
  @Test
  ...
  /**
   * Level Element WALL should get "wall_outer_corner_bottom_right" texture if upper left is FLOOR,
   * above is WALL and left is WALL.
   */
  @Test
  ...
  /**
   * Level Element WALL should get "wall_outer_corner_bottom_left" texture if upper right is FLOOR,
   * above is WALL and right is WALL.
   */
  @Test
  ...
  /**
   * Level Element WALL should get "wall_inner_corner_upper_left" texture if below is WALL, right is
   * WALL and inner corner conditions are met.
   */
  @Test
  ...
  /**
   * Level Element WALL should get "wall_inner_corner_upper_right" texture if below is WALL, left is
   * WALL and inner corner conditions are met.
   */
  @Test
